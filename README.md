...
A modern, responsive e-commerce web application designed for a sustainable thrift store brand. The project features a clean, minimal user interface focused on providing a seamless shopping experience for unique second-hand fashion.

## 🚀 Live Demo
**View the live site here:** [https://my-thrift-store.vercel.app/](https://my-thrift-store.vercel.app/)

## ✨ Features
* **Dynamic Navigation:** Categorized browsing for Shirts, Pants, Winter wear, and more.
* **Modern UI/UX:** Features a promotional banner with discount codes and an aesthetic color palette.
* **Shopping Experience:** Includes dedicated pages for Cart, Product details, and Order History.
* **Responsive Design:** Fully optimized for mobile, tablet, and desktop viewing.
* **Admin Access:** Integrated admin portal link for inventory management.
